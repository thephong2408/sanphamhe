    ...
    return (
        <div className="sm:h-[35px] h-[25px] flex items-center">
            <div className="relative rounded-full">
                <input
                    className="px-10 md:w-[500px] w-[230px] sm:h-[35px] h-[25px] text-[#323232] lg:text-[15px] text-[12px] border-none rounded-full bg-white"
                    type="text"
                ...
                {/* show results */}
                {showResults && (
                    <div className="absolute sm:max-h-[300px] max-h-[200px] overflow-y-auto sm:top-[40px] top-[30px] z-10 bg-white p-5 w-full border-[1px]  text-[#000] sm:text-[15px] text-[10px]">
                        {/* san pham */}
